...
if(!isset($_SESSION['user_id'])) {
  ...
  $root_depth = substr_count(str_replace('\\','/',rtrim($_SERVER['DOCUMENT_ROOT'],'/')), '/');
  $levels = $depth - $root_depth;
  // Buscar si hay una carpeta edutest2026 como subfolder
...
// base_url: detecta automaticamente la carpeta raiz del proyecto
